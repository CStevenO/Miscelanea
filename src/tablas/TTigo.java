 ...
 */
public class TTigo {
    List columnIdentifiers = Arrays.asList(new Object[]{"fecha","pagado","recargado","debe","ventas","saldo","ganancias","caja","sugerencia","retiro","gananciasSim"});
    public GenericDomainTableModel<MTigo> model = new GenericDomainTableModel<MTigo>(columnIdentifiers) {
        ...
        public Object getValueAt(int rowIndex, int columnIndex) {
            MTigo recarga = getDomainObject(rowIndex);
            switch(columnIndex) {
                ...
                case 10: return recarga.getGananciasSim();
        ...
        public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
            ...
            switch(columnIndex) {
                ...
                case 10: recarga.setGananciasSim((Long) aValue); break;
                default: throw new ArrayIndexOutOfBoundsException(columnIndex);
            }
